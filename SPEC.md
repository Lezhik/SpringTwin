...
## Команда
    ...
    spring-twin cluster
      --deps <file>
      --output <file>
      --resolution <параметр кластеризации, определяет размер кластеров 0.5 - 5.0>
...
## Параметры
  ...
  `--resolution`    параметр кластеризации, по умолчанию 1.5
...
Для кластеризации используется Leiden Algorithm для неориентированного графа, 
реализацию которого нужно написать.
Параметры кластеризации: 
- resolution - определяет размер кластеров, задается из командной строки, по умолчанию 1.5
