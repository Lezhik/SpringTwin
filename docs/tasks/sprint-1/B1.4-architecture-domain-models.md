...
- [ ] Создан класс ClassNode в package domain модуля architecture
- [ ] Создан класс MethodNode в package domain модуля architecture
- [ ] Создан класс EndpointNode в package domain модуля architecture
- [ ] Все модели используют Lombok аннотации: @Data, @Builder, @NoArgsConstructor, @AllArgsConstructor
- [ ] Все модели имеют JavaDoc описание класса
- [ ] Созданы DTO классы для Request и Response для каждой модели
- [ ] DTO классы используют Lombok аннотации
- [ ] Созданы Mapper классы для преобразования моделей в DTO и обратно
