...
- [x] Добавлена зависимость spring-modulith-starter в build.gradle.kts
- [x] Созданы классы конфигурации для каждого модуля с аннотацией @Module
- [x] Настроены зависимости между модулями через @Module annotation
- [x] Модуль app агрегирует все остальные модули
- [x] Modulith verification test проходит успешно
- [x] Границы модулей проверяются автоматически
- [x] Документация модулей генерируется корректно
...
- Использовать Spring Modulith 1.x+ для совместимости с Spring Boot 4.x
