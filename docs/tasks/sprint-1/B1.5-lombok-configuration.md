...
- [ ] Добавлена зависимость Lombok в build.gradle.kts (compileOnly)
- [ ] Добавлен annotationProcessor для Lombok в build.gradle.kts
- [ ] Создан файл lombok.config в корне проекта
- [ ] lombok.config содержит настройку config.stopBubbling = true
- [ ] lombok.config содержит настройку для добавления полей в Builder
- [ ] Создан тестовый класс для проверки @Data, @Builder, @NoArgsConstructor, @AllArgsConstructor
- [ ] Создан тестовый класс для проверки @Slf4j
- [ ] Создан тестовый класс для проверки @RequiredArgsConstructor
